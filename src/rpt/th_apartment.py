...
2019년 4분기에서 2020년 1분기로 넘어갈 때 어디가 가장 많이 증가했는지 파악 
-> 아파트 단지 수: 오패산로52길, 백제고분로50길, 백제고분로34길, 암사길, 개봉로11길, 백제고분로32길, 초록마을로8길 등 가장 많이 증가
-> 아파트 평균 시가 차이: 선릉역1, 한강대로43길, 강남역1, 대치역2, 압구정 로데오거리1, 중구 명동역, 사평대로26길, 모래내로15길 등 가장 많이 증가
분석 결과2: 구별로 확인한 결과, 
...
# 분기별 아파트 단지 수 왜 늘었는지? 평균 시가 왜 올랐는지? 2019년 4분기 vs 2020년 1분기
상권_아파트_2019_4 = 상권_아파트[상권_아파트['분기_코드'].str.contains("2019Q4")]
상권_아파트_2020_1 = 상권_아파트[상권_아파트['분기_코드'].str.contains("2020Q1")]

상권_아파트_2019_4 = 상권_아파트_2019_4.groupby(['상권_코드_명']).agg(아파트_단지_수_4=('아파트_단지_수','sum'),아파트_평균_시가_4=('아파트_평균_시가', 'sum'))
상권_아파트_2020_1 = 상권_아파트_2020_1.groupby(['상권_코드_명']).agg(아파트_단지_수_1=('아파트_단지_수','sum'),아파트_평균_시가_1=('아파트_평균_시가', 'sum'))

상권_아파트_1920 = pd.merge(상권_아파트_2019_4, 상권_아파트_2020_1, on='상권_코드_명')
상권_아파트_1920['아파트 단지 수 차이(1-4)'] = 상권_아파트_1920['아파트_단지_수_1']-상권_아파트_1920['아파트_단지_수_4']
상권_아파트_1920['아파트 평균 시가 차이(1-4)'] = 상권_아파트_1920['아파트_평균_시가_1']-상권_아파트_1920['아파트_평균_시가_4']
상권_아파트_1920 = 상권_아파트_1920.sort_values(by='아파트 단지 수 차이(1-4)', ascending=False)
상권_아파트_1920 = 상권_아파트_1920.sort_values(by='아파트 평균 시가 차이(1-4)', ascending=False)
