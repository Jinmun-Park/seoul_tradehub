...
생활인구_pct = 상권_생활인구[상권_생활인구['분기_코드'].str.contains("2018Q4|2019Q1")]
생활인구_pct = 생활인구_pct.groupby(['기준_년_코드','기준_분기_코드','분기_코드','상권_코드_명']).agg(
    총_생활인구_수=('총_생활인구_수', 'sum'),
    남성_생활인구_수=('남성_생활인구_수', 'sum'),
    여성_생활인구_수=('여성_생활인구_수', 'sum')).reset_index()

생활인구_pct['생활인구_pct_change_상권'] = 생활인구_pct.sort_values(['분기_코드']).groupby(['상권_코드_명']).총_생활인구_수.pct_change()
생활인구_pct = 생활인구_pct.sort_values(by='생활인구_pct_change_상권', ascending=False)

# pct change로 확인해보기 _ 구별
생활인구_pct = 상권_생활인구[상권_생활인구['분기_코드'].str.contains("2018Q4|2019Q1")]
생활인구_pct = 생활인구_pct.groupby(['기준_년_코드','기준_분기_코드','분기_코드','시군구']).agg(
    총_생활인구_수=('총_생활인구_수', 'sum'),
    남성_생활인구_수=('남성_생활인구_수', 'sum'),
    여성_생활인구_수=('여성_생활인구_수', 'sum')).reset_index()

생활인구_pct['생활인구_pct_change_시군구'] = 생활인구_pct.sort_values(['분기_코드']).groupby(['시군구']).총_생활인구_수.pct_change()
생활인구_pct = 생활인구_pct.sort_values(by='생활인구_pct_change_시군구', ascending=False)
