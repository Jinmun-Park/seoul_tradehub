...
2019년 1분기에서 2019년 2분기로 넘어갈 때 어디가 가장 많이 줄었는지 파악 -> 명동 남대문 북창동 다동 무교동 관광특구, 종로구청, 여의도역, 구로디지털1단지, 을지로3가역 가장 많이 감소
분석 결과 2 : 구별로 확인한 결과,
...
상권_직장인구_1920 = 상권_직장인구_1920.sort_values(by='직장 인구 차이(2-1)', ascending=False)
